...
bossbar set nightly_building name {"text":"JE-Dimensions-1.20.5/1.20.6-Skyblock_Classic_Edition:NIGHTLY_BUILDING_28.05.2024.11550a_[dimensions_version]","color":"white","bold":true}
