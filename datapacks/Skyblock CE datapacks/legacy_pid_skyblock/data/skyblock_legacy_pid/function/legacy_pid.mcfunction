...
execute as @a[scores={1.21_PID_0=-100..}] run scoreboard players set @a ID_5 1
...
execute as @a[scores={PID_legacy_v2=905..}] run scoreboard objectives remove PID_0
execute as @a[scores={PID_legacy_v3=1355..}] run scoreboard objectives remove PID_1
...
execute as @a[scores={ID_5=1..}] run tellraw @a ["",{"text":"\u2716","color":"red"},{"translate":"skyblock_classic_edition.version_update.compatible.minecraft_versions"},{"text":"1.16.X - 1.17.1/1.18.1 - 1.18.2 - 1.19.4 - 1.20.2/1.20.3 - 1.20.4","bold":true},{"translate":"skyblock_classic_edition.version_update.compatible.info"}]
...
##The Nether
execute as @a[scores={PID_legacy_v2=100..500}] run scoreboard players set @a SkyblockCE_islands 4
execute in minecraft:the_nether as @a[scores={PID_legacy_v2=300}] run tp @a 0 -3 30
execute in minecraft:the_nether as @a[scores={PID_legacy_v2=350}] run fill 2 2 33 -2 2 29 minecraft:infested_cobblestone destroy
execute in minecraft:the_nether as @a[scores={PID_legacy_v2=400}] run setblock 0 3 31 oak_sign[rotation=8,waterlogged=false]{front_text:{color:"black",has_glowing_text:1b,messages:['{"text":"The portal is"}','{"text":"broken sorry.."}','{"text":";("}','{"text":"since: 1.0.0"}']}} destroy
execute in minecraft:the_nether as @a[scores={PID_legacy_v2=500}] run scoreboard players set @a SkyblockCE_tp 1
execute as @a[scores={PID_legacy_v2=550}] run scoreboard players set @a SkyblockCE_tp 0
execute as @a[scores={PID_legacy_v2=600..700}] run gamemode spectator @a
execute as @a[scores={PID_legacy_v2=700}] in minecraft:overworld run tp @a 0 66 0
execute in minecraft:overworld as @a[scores={PID_legacy_v2=750}] run setblock 0 62 0 minecraft:black_concrete keep
execute as @a[scores={PID_legacy_v2=830}] run advancement revoke @a only minecraft:end/root
execute as @a[scores={PID_legacy_v2=830}] run advancement revoke @a only minecraft:nether/root
...
execute as @a[scores={PID_legacy_v2=746}] run scoreboard players set @a PID_1 5
...
execute in minecraft:overworld as @a[scores={PID_legacy_v3=150}] run setblock 295 50 2 minecraft:barrel[facing=south,open=false]{Items:[{count:1b,Slot:13b,id:"minecraft:coast_armor_trim_smithing_template"}]} keep
...
execute in minecraft:overworld as @a[scores={PID_legacy_v3=350}] run setblock 507 46 71 minecraft:barrel[facing=east,open=false]{Items:[{count:1b,Slot:13b,id:"minecraft:sentry_armor_trim_smithing_template"}]} keep
...
execute in minecraft:overworld as @a[scores={PID_legacy_v3=650}] run setblock -49 50 503 minecraft:barrel[facing=west,open=false]{Items:[{count:1b,Slot:13b,id:"minecraft:wild_armor_trim_smithing_template"}]} keep
execute in minecraft:overworld as @a[scores={PID_legacy_v3=700}] run tp @a 71 59 -489 0 0
execute in minecraft:overworld as @a[scores={PID_legacy_v3=780}] run setblock 77 55 -491 minecraft:chest[facing=north,type=single,waterlogged=false]{Items:[{count:1b,Slot:0b,id:"minecraft:string"},{count:1b,Slot:1b,id:"minecraft:brewer_pottery_sherd"},{count:1b,Slot:2b,id:"minecraft:feather"},{count:1b,Slot:3b,id:"minecraft:string"},{count:1b,Slot:5b,id:"minecraft:sand"},{count:1b,Slot:6b,id:"minecraft:saddle"},{count:3b,Slot:7b,id:"minecraft:bone"},{count:1b,Slot:8b,id:"minecraft:sand"},{count:1b,Slot:9b,id:"minecraft:rotten_flesh"},{count:3b,Slot:10b,id:"minecraft:sand"},{count:1b,Slot:11b,id:"minecraft:string"},{count:1b,Slot:13b,id:"minecraft:dune_armor_trim_smithing_template"},{count:2b,Slot:14b,id:"minecraft:sand"},{count:1b,Slot:15b,id:"minecraft:skull_pottery_sherd"},{count:1b,Slot:16b,id:"minecraft:bone"},{count:1b,Slot:17b,id:"minecraft:string"},{count:2b,Slot:18b,id:"minecraft:bone"},{count:1b,Slot:19b,id:"minecraft:sand"},{count:1b,Slot:20b,id:"minecraft:sand"},{count:1b,Slot:21b,id:"minecraft:arms_up_pottery_sherd"},{count:1b,Slot:22b,id:"minecraft:sand"},{count:1b,Slot:23b,id:"minecraft:bone"},{count:2b,Slot:24b,id:"minecraft:rotten_flesh"},{count:2b,Slot:25b,id:"minecraft:string"}]} keep
execute in minecraft:overworld as @a[scores={PID_legacy_v3=785}] run fill 73 58 -487 69 58 -491 minecraft:smooth_sandstone keep
execute in minecraft:overworld as @a[scores={PID_legacy_v3=800}] run tp @a -253 66 -476
execute in minecraft:overworld as @a[scores={PID_legacy_v3=805}] run fill -251 63 -478 -255 63 -474 minecraft:acacia_planks keep
execute in minecraft:overworld as @a[scores={PID_legacy_v3=850}] run setblock -253 64 -476 minecraft:spawner{Delay:0s,MaxNearbyEntities:6s,MaxSpawnDelay:800s,MinSpawnDelay:200s,RequiredPlayerRange:16s,SpawnCount:4s,SpawnData:{entity:{id:"minecraft:armadillo"}},SpawnPotentials:[],SpawnRange:4s} destroy
execute in minecraft:overworld as @a[scores={PID_legacy_v3=855}] run setblock -253 64 -475 minecraft:oak_wall_sign[facing=south,waterlogged=false]{back_text:{color:"black",has_glowing_text:0b,messages:['""','""','""','""']},front_text:{color:"black",has_glowing_text:1b,messages:['"To farming"','"armadillos"','""','""']},is_waxed:0b} destroy
execute in minecraft:overworld as @a[scores={PID_legacy_v3=856}] run setblock -253 65 -476 minecraft:torch keep
execute in minecraft:overworld as @a[scores={PID_legacy_v3=860}] run scoreboard players set @a SkyblockCE_level_dat 50000
execute in minecraft:overworld as @a[scores={PID_legacy_v3=860}] run tellraw @a [{"translate":"skyblock_classic_edition.warning_level.dat.issues","color":"red","italic":true},{"translate":"skyblock_classic_edition.warning_level.dat.download","color":"red","italic":true,"underlined":true,"clickEvent":{"action":"open_url","value":"https://github.com/Loweredgames/Skyblock-Classic-Edition/raw/main/.worlds/.worlds-level.dat/Level.dat.zip"}},{"translate":"skyblock_classic_edition.warning_level.dat.copy_paste","color":"red","italic":true},{"text":"/scoreboard objectives add fix_custom_world dummy","underlined":true,"clickEvent":{"action":"copy_to_clipboard","value":"/scoreboard objectives add fix_custom_world dummy"}},{"translate":"skyblock_classic_edition.warning_level.dat.end","color":"red","italic":true}]
execute in minecraft:overworld as @a[scores={PID_legacy_v3=860}] run tp @a 722 50 703 0.0 0.0
execute in minecraft:overworld as @a[scores={PID_legacy_v3=865..}] run setblock 722 48 703 minecraft:end_portal_frame[eye=false,facing=south] replace


###SUBPID LEGACY (AGGIUNGERE TUTTI I SUBPID ATTACCATO AL PID MADRE. SE NON CI SONO SUBPID NON AGGIUNGERE QUESTA SEZIONE)
execute in minecraft:overworld as @a[scores={PID_legacy_v3=900}] run tp @a -252 60 -476 0 0
execute in minecraft:overworld as @a[scores={PID_legacy_v3=910}] run setblock -252 52 -476 minecraft:air keep
execute in minecraft:overworld as @a[scores={PID_legacy_v3=915}] run setblock -252 52 -476 minecraft:decorated_pot[cracked=false,facing=south,waterlogged=false]{item:{count:7b,id:"minecraft:iron_nugget"}} keep
execute in minecraft:overworld as @a[scores={PID_legacy_v3=920}] run setblock -262 57 -480 minecraft:air keep
execute in minecraft:overworld as @a[scores={PID_legacy_v3=925}] run setblock -262 57 -480 minecraft:decorated_pot[cracked=false,facing=north,waterlogged=false]{item:{count:32b,id:"minecraft:clay_ball"}} keep
execute in minecraft:overworld as @a[scores={PID_legacy_v3=930}] run setblock -261 53 -478 minecraft:air keep
execute in minecraft:overworld as @a[scores={PID_legacy_v3=935}] run setblock -261 53 -478 minecraft:decorated_pot[cracked=false,facing=south,waterlogged=false]{item:{count:8b,id:"minecraft:string"}} keep
execute in minecraft:overworld as @a[scores={PID_legacy_v3=940}] run setblock -265 47 -471 minecraft:air keep
execute in minecraft:overworld as @a[scores={PID_legacy_v3=945}] run setblock -265 47 -471 minecraft:decorated_pot[cracked=false,facing=south,waterlogged=false]{item:{count:12b,id:"minecraft:wheat"}} keep
execute in minecraft:overworld as @a[scores={PID_legacy_v3=950}] run setblock -249 53 -482 minecraft:air keep
execute in minecraft:overworld as @a[scores={PID_legacy_v3=955}] run setblock -249 53 -482 minecraft:decorated_pot[cracked=false,facing=west,waterlogged=false]{item:{count:24b,id:"minecraft:brick"}} keep
execute in minecraft:overworld as @a[scores={PID_legacy_v3=960}] run setblock -262 57 -471 minecraft:air keep
execute in minecraft:overworld as @a[scores={PID_legacy_v3=965}] run setblock -262 57 -471 minecraft:decorated_pot[cracked=false,facing=west,waterlogged=false]{item:{count:1b,id:"minecraft:orange_dye"}} keep
execute in minecraft:overworld as @a[scores={PID_legacy_v3=970}] run setblock -245 53 -474 minecraft:air keep
execute in minecraft:overworld as @a[scores={PID_legacy_v3=975}] run setblock -245 53 -474 minecraft:decorated_pot[cracked=false,facing=north,waterlogged=false]{item:{count:6b,id:"minecraft:blue_dye"}} keep
...
##The Nether
execute in minecraft:the_nether as @a[scores={PID_legacy_v3=1000}] run tp @a 5 58 33 0 0
execute in minecraft:the_nether as @a[scores={PID_legacy_v3=1050}] run fill 6 57 33 4 57 35 minecraft:polished_blackstone_bricks keep
execute in minecraft:the_nether as @a[scores={PID_legacy_v3=1151}] run setblock 5 58 34 chest[facing=north,type=single,waterlogged=false]{Items:[{Slot:0b,id:"minecraft:gilded_blackstone",count:2},{Slot:1b,id:"minecraft:piglin_banner_pattern",count:1},{Slot:2b,id:"minecraft:netherite_upgrade_smithing_template",count:1},{Slot:3b,id:"minecraft:magma_cream",count:1},{Slot:4b,id:"minecraft:gold_nugget",count:1},{Slot:5b,id:"minecraft:chain",count:1},{Slot:6b,id:"minecraft:music_disc_pigstep",count:1},{Slot:7b,id:"minecraft:gilded_blackstone",count:1},{Slot:8b,id:"minecraft:snout_armor_trim_smithing_template",count:1},{Slot:9b,id:"minecraft:netherite_scrap",count:1},{Slot:10b,id:"minecraft:rib_armor_trim_smithing_template",count:1},{Slot:11b,id:"minecraft:gold_nugget",count:1},{Slot:12b,id:"minecraft:gilded_blackstone",count:1},{Slot:13b,id:"minecraft:gilded_blackstone",count:1},{Slot:14b,id:"minecraft:magma_cream",count:1},{Slot:16b,id:"minecraft:chain",count:1},{Slot:17b,id:"minecraft:gold_nugget",count:1},{Slot:18b,id:"minecraft:chain",count:1},{Slot:20b,id:"minecraft:gilded_blackstone",count:1},{Slot:22b,id:"minecraft:netherite_upgrade_smithing_template",count:1},{Slot:23b,id:"minecraft:netherite_scrap",count:1},{Slot:24b,id:"minecraft:chain",count:1},{Slot:25b,id:"minecraft:enchanted_book",count:1,components:{"minecraft:stored_enchantments":{levels:{"minecraft:soul_speed":3}}}},{Slot:26b,id:"minecraft:magma_cream",count:2}]} keep
execute in minecraft:the_nether as @a[scores={PID_legacy_v3=1255}] run setblock 6 58 34 minecraft:piglin_head[rotation=15] keep
execute in minecraft:the_nether as @a[scores={PID_legacy_v3=1256}] run setblock 4 58 34 minecraft:piglin_head[rotation=1] keep
execute in minecraft:overworld as @a[scores={PID_legacy_v3=1260}] run tp @a 0 66 0 0 0
execute in minecraft:overworld as @a[scores={PID_legacy_v3=1305}] run gamemode survival @a


##PID LEGACY SETUP - v3 (Aggiornato all'ultima versione: 6.0.0 Minecraft: 1.21) Ricordati di aggiornare UPDATE ID e di aggiungere l'ultima conversione. ricordarsi di rimuovere i pid secondari come PID_1_1 nella stessa categoria.
execute as @a[scores={PID_legacy_v3=1..1250}] run gamemode spectator @a
execute as @a[scores={PID_legacy_v3=10..1300}] run effect give @a blindness 11 0 true
execute as @a[scores={PID_legacy_v3=10..1300}] run effect give @a night_vision 11 0 true
execute as @a[scores={PID_legacy_v3=1..1301}] run summon minecraft:area_effect_cloud ~ ~1 ~
execute as @a[scores={PID_legacy_v3=1340}] run playsound minecraft:entity.player.levelup ambient @a 0 66 0 100 2
...
execute as @a[scores={PID_legacy_v3=1350}] run scoreboard objectives add PID_legacy dummy
