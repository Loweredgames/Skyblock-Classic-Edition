...
##Overworld
execute in minecraft:overworld as @a[scores={1.20.5_PID_0=100..505}] run tp @a 0 66 0 90 0
...
execute as @a[scores={1.20.5_PID_0=105}] run scoreboard players set @a SkyblockCE_level_dat 900
