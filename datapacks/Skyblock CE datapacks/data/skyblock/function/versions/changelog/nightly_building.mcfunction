...
bossbar set nightly_building name {"text":"JE-1.21/1.21.1-6.0.0-Skyblock_Classic_Edition:NIGHTLY_BUILDING_25.12.2024.11807a_[6.0.0-1.21.X]","color":"white","bold":true}
