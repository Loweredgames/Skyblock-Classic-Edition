...
bossbar set nightly_building name {"text":"JE-1.21/1.21.1-6.0.0-Skyblock_Classic_Edition:NIGHTLY_BUILDING_17.11.2024.22148a_[remove_all]","color":"white","bold":true}
