...
execute as @a[scores={SkyOsirion_install=1..}] run scoreboard players set @a 1.21_PID_0 -10000
execute as @a[scores={SkyOsirion_install_test=1..}] run scoreboard players set @a 1.21_PID_0 -10000
execute as @a[scores={SkyOsirion_multiplayer_join=2..}] run scoreboard players set @a 1.21_PID_0 24000


##SKYBLOCK PID VERSIONS (LASCIARE SEMPRE COSI)
execute as @a[scores={SkyOsirion_multiplayer_reset=1}] run function skyblock:versions/pid_setup
...
#execute as @a[scores={SkyOsirion_id=2000..}] run scoreboard objectives add PID_lts_warning dummy
...
#execute as @a[scores={SkyOsirion_id=2000..}] run scoreboard objectives add PID_warning dummy
