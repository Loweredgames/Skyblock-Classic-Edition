...
execute as @a[scores={SkyOsirion_id=10}] run scoreboard objectives remove 1.21.4_PVN_0a
execute as @a[scores={SkyOsirion_import=20}] run scoreboard objectives remove 1.21.4_PVN_0a
