...
execute as @a[scores={SkyblockCE_multiplayer_reset=-1}] run clear @a written_book[custom_data={tag:generated_book}]
...
execute as @a[scores={SkyblockCE_multiplayer_join=0..5}] run tp @p 0 65 0 0 0
