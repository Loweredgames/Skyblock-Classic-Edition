...
bossbar set building name {"text":"JE-Dimensions-1.20.6-Skyblock_Classic_Edition:BUILDING:TODO_LTS","color":"white","bold":true}


##MAP PROGRESS (I PROGRESSI DELLA MAPPA, E UN NUMERO APROSSIMATO)
bossbar set minecraft:building value 70
