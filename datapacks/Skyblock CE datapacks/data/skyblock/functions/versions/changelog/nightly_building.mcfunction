...
bossbar set nightly_building name {"text":"JE-1.20.6-5.3.1-Skyblock_Classic_Edition:NIGHTLY_BUILDING_27.09.2024.31250a_[5.0.0-1.20.X]","color":"white","bold":true}
