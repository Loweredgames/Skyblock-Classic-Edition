...
bossbar set nightly_building name {"text":"JE-1.20.5/1.20.6-Skyblock_Classic_Edition:NIGHTLY_BUILDING_28.04.2024.21248a_[new_recipes_fix]","color":"white","bold":true}
