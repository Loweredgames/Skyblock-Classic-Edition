...
bossbar set nightly_building name {"text":"JE-1.20.5/1.20.6-Skyblock_Classic_Edition:NIGHTLY_BUILDING_18.08.2024.11700_[skyblock_test_changes]","color":"white","bold":true}
