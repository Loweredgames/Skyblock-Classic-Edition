...
bossbar set nightly_building name {"text":"JE-1.20.5/1.20.6-Skyblock_Classic_Edition:NIGHTLY_BUILDING_23.05.2024.22255a_[fix_structures_world]","color":"white","bold":true}
