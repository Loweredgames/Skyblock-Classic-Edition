...
bossbar set nightly_building name {"text":"JE-Dimensions-1.20.6-Skyblock_Classic_Edition:NIGHTLY_BUILDING_19.09.2024.41402a_[dimensions_version]","color":"white","bold":true}
