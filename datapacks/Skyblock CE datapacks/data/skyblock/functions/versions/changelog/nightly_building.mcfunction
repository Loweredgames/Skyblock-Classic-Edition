...
bossbar set nightly_building name {"text":"JE-Dimensions-1.20.5/1.20.6-Skyblock_Classic_Edition:NIGHTLY_BUILDING_08.08.2024.22204a_[dimensions_version]","color":"white","bold":true}
