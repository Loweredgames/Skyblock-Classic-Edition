...
scoreboard objectives add 1.20.5_PVN_0h dummy
scoreboard players add @a 1.20.5_PVN_0h 1
execute as @a[scores={SkyblockCE_id=10}] run scoreboard objectives remove 1.20.5_PVN_0h


##PVN VERSION LEGACY PROTOCOL (DA AGGIUNGERE SOLO QUANDO IL NUMERO CAMBIA)
scoreboard objectives add PVN_legacy dummy
scoreboard players set @a 1.20.3_PVN_1 1
execute as @a[scores={1.20.3_PVN_1=1..}] run scoreboard players add @a PVN_legacy 1
...
execute as @a[scores={PVN_legacy=201..}] run scoreboard objectives remove 1.20.3_PVN_1
