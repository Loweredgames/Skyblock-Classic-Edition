...
scoreboard objectives add 1.20.5_PVN_0 dummy
scoreboard players add @a 1.20.5_PVN_0 1
execute as @a[scores={SkyblockCE_id=10}] run scoreboard objectives remove 1.20.5_PVN_0
