...
scoreboard objectives add 1.20.5_PVN_0g dummy
scoreboard players add @a 1.20.5_PVN_0g 1
execute as @a[scores={SkyblockCE_id=10}] run scoreboard objectives remove 1.20.5_PVN_0g
