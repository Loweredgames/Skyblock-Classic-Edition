...
scoreboard objectives add 1.20.6_PVN_0b dummy
scoreboard players add @a 1.20.6_PVN_0b 1
execute as @a[scores={SkyblockCE_id=10}] run scoreboard objectives remove 1.20.6_PVN_0b
