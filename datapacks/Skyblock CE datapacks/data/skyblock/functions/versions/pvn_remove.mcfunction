...
#scoreboard objectives remove 1.20.3_PVN_1 (da aggiungere nella 1.21 e poi backporting alla 1.20.6)
...
scoreboard objectives remove 1.20.3_PVN_0d
...
scoreboard objectives remove 1.20.2_PVN_0b
...
scoreboard objectives remove PVN_10b
scoreboard objectives remove PVN_10c
scoreboard objectives remove PVN_10d
scoreboard objectives remove PVN_10e
...
scoreboard objectives remove PVN_5
scoreboard objectives remove PVN_4
scoreboard objectives remove PVN_3
