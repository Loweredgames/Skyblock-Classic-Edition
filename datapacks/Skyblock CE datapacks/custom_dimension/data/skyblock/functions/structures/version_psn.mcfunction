...
#execute as @a[scores={PSN_legacy=5}] run scoreboard objectives add SkyblockCE_generated_book dummy (TO DO: da fare nella prossima versione. la 1.21 e backporting)
