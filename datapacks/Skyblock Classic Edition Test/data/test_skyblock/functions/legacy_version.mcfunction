...
execute as @a[scores={SkyblockCE_legacy_version=1..}] run gamemode spectator @a
...
execute in minecraft:the_nether as @a[scores={SkyblockCE_legacy_version=4100}] run tp @a 0 -3 30
execute in minecraft:the_nether as @a[scores={SkyblockCE_legacy_version=4200}] run fill 2 2 33 -2 2 29 minecraft:infested_cobblestone destroy
execute in minecraft:the_nether as @a[scores={SkyblockCE_legacy_version=4300}] run setblock 0 3 31 oak_sign[rotation=8,waterlogged=false]{front_text:{color:"black",has_glowing_text:1b,messages:['{"text":"The portal is"}','{"text":"broken sorry.."}','{"text":";("}','{"text":""}']}} destroy
execute as @a[scores={SkyblockCE_legacy_version=..5000}] run scoreboard players set @a PID_1 -10
#execute in minecraft:overworld at @a[scores={SkyblockCE_legacy_version=5010}] run tp @a 0 66 0 ~ ~
#execute as @a[scores={SkyblockCE_legacy_version=6010..}] run gamemode survival @a
