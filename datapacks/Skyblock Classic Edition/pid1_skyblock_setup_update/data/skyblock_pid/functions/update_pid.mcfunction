...
##SUBPID 1.20.5_1_4 - 1.20.5 Armadillo BETA and structure BETA (LASCIARE COSI. PER LA FUNZIONE SUBPID 1_4, VERSIONE MINORE DA SPOSTARE IN LEGACY QUANDO IL PID DIVENTA INCOMPATIBILE)
