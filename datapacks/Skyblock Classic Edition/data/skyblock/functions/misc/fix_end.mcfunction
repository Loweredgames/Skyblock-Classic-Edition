...
execute in minecraft:the_end as @a[scores={fix_end=6}] run summon endermite 0 70 0 {Silent:1b,Glowing:1b,CustomNameVisible:1b,PersistenceRequired:1b,NoAI:1b,Health:1f,PlayerSpawned:0b,CustomName:'{"text":"fix"}'}
