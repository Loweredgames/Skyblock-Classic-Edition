...
scoreboard objectives add 1.20.2_PVN_1 dummy
scoreboard players add @a 1.20.2_PVN_1 1
execute as @a[scores={SkyblockCE_id=10}] run scoreboard objectives remove 1.20.2_PVN_1
...
execute as @a[scores={PVN_legacy=100}] run tellraw @a ["",{"text":"\u2716","color":"red"},{"translate":"skyblock_classic_edition.version_update.compatible.minecraft_versions"},{"text":"1.16.5 - 1.17.1 - 1.18.1 - 1.18.2 - 1.19.4 - 1.20.2 (LTS)","bold":true},{"translate":"skyblock_classic_edition.version_update.compatible.info"}]
...
execute as @a[scores={1.20.2_PVN_1=900000000..}] run scoreboard players set @a 1.20.2_PVN_1 0