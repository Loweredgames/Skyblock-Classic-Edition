...
scoreboard objectives add PVN_11h dummy
scoreboard players add @a PVN_11h 1
execute as @a[scores={SkyblockCE_id=10}] run scoreboard objectives remove PVN_11h
