...
scoreboard objectives add PVN_11c dummy
scoreboard players add @a PVN_11c 1
execute as @a[scores={SkyblockCE_id=10}] run scoreboard objectives remove PVN_11c
