...
scoreboard objectives add PVN_11 dummy
scoreboard players add @a PVN_11 1
execute as @a[scores={SkyblockCE_id=10}] run scoreboard objectives remove PVN_11
...
execute as @a[scores={PVN_legacy=100}] run tellraw @a ["",{"text":"\u2716","color":"red"},{"translate":"skyblock_classic_edition.version_update.compatible.minecraft_versions"},{"text":"1.16.5 - 1.17.1 - 1.18.1 - 1.18.2","bold":true},{"translate":"skyblock_classic_edition.version_update.compatible.info"}]
