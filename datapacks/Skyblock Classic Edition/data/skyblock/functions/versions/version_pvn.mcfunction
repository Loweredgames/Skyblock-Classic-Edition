...
scoreboard objectives add PVN_11b dummy
scoreboard players add @a PVN_11b 1
execute as @a[scores={SkyblockCE_id=10}] run scoreboard objectives remove PVN_11b
...
execute as @a[scores={PVN_11b=900000000..}] run scoreboard players set @a PVN_11b 0