...
scoreboard objectives add 1.20.3_PVN_1a dummy
scoreboard players add @a 1.20.3_PVN_1a 1
execute as @a[scores={SkyblockCE_id=10}] run scoreboard objectives remove 1.20.3_PVN_1a


##PVN VERSION LEGACY PROTOCOL (DA AGGIUNGERE SOLO QUANDO IL NUMERO CAMBIA)
scoreboard objectives add PVN_legacy dummy
scoreboard players set @a PVN_12 1
execute as @a[scores={PVN_12=1..}] run scoreboard players add @a PVN_legacy 1
...
execute as @a[scores={PVN_legacy=201..}] run scoreboard objectives remove PVN_12
...
execute as @a[scores={1.20.3_PVN_1a=900000000..}] run scoreboard players set @a 1.20.3_PVN_1a 0