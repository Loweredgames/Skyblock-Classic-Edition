...
##Refactoring Scoreboard (Aggiornato all'ultima versione: 1.0.0 - 5.0.0 Minecraft: 1.19.4)
...
execute as @a[scores={refactoring_scoreboard=..5}] run scoreboard players set @a SkyblockCE_id 1000
execute as @a[scores={refactoring_scoreboard=1..1000}] run effect clear @a
...
scoreboard players set @a PID_0 0