...
bossbar set building name {"text":"JE-1.20-23w12a-Skyblock_Classic_Edition:BUILDING:29.03.2023a","color":"white","bold":true}

#Map Progress

bossbar set minecraft:building value 50
