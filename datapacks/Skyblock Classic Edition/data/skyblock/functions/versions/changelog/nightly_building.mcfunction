...
bossbar set nightly_building name {"text":"JE-1.20.5/1.20.6-Skyblock_Classic_Edition:NIGHTLY_BUILDING_28.04.2024.21449a_[fix_structures_world]","color":"white","bold":true}
