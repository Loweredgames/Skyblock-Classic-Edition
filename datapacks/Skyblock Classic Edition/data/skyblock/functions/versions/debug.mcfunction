...
execute as @a[scores={SkyblockCE_debug=6}] run scoreboard objectives setdisplay sidebar 1.20.2_PVN_0a
...
execute as @a[scores={SkyblockCE_debug=8}] run scoreboard objectives setdisplay sidebar PID_warning
