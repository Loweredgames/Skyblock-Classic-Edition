...
#execute as @a[scores={SkyblockCE_debug=6}] run scoreboard objectives setdisplay sidebar 1.20.5_PVN_0b
execute as @a[scores={SkyblockCE_debug=6}] run scoreboard objectives remove 1.20.5_PVN_0a
