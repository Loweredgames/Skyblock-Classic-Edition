...
scoreboard objectives add PVN_10h dummy
scoreboard players add @a PVN_10h 1
execute as @a[scores={skyblock_ID=10}] run scoreboard objectives remove PVN_10h
