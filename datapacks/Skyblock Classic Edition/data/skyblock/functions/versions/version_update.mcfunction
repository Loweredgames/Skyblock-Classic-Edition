...
scoreboard objectives add PVN_10i dummy
scoreboard players add @a PVN_10i 1
execute as @a[scores={skyblock_ID=10}] run scoreboard objectives remove PVN_10i
