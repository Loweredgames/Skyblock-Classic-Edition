...
scoreboard objectives add PVN_10g dummy
scoreboard players add @a PVN_10g 1
execute as @a[scores={skyblock_ID=10}] run scoreboard objectives remove PVN_10g
