...
execute as @a[scores={skyblock_island=1}] run scoreboard objectives add SkyblockCE_large minecraft.custom:minecraft.play_time
...
execute as @a[scores={SkyblockCE_large=1..}] run scoreboard players set @a skyblock_island -1
...
#Large Classic
execute in minecraft:overworld as @a[scores={SkyblockCE_large=1}] run scoreboard players set @a tp 1
...
execute in minecraft:overworld as @a[scores={SkyblockCE_large=33}] run setblock -1 68 -1 birch_wall_sign[facing=south,waterlogged=false]{back_text:{messages:['{"text":"This"}','{"text":"is"}','{"text":"a"}','{"text":"secret!!!"}']},front_text:{color:"white",has_glowing_text:1b,messages:['{"text":"Skyblock"}','{"text":"Classic Edition"}','{"text":"---------------"}','{"text":"1.20"}']}} replace
execute in minecraft:overworld as @a[scores={SkyblockCE_large=35}] run setblock -1 68 0 minecraft:air


#Large Classic Desert
execute in minecraft:overworld as @a[scores={SkyblockCE_large=40}] run scoreboard players set @a tp 2
...
execute in minecraft:overworld as @a[scores={SkyblockCE_large=57}] run scoreboard players set @a tp 3
...
execute as @a[scores={SkyblockCE_large=120}] run scoreboard players set @a tp 4
...
execute as @a[scores={SkyblockCE_large=130}] run scoreboard players set @a tp 5
...
##Final Function
execute as @a[scores={SkyblockCE_large=150}] run scoreboard players set @a tp 1
execute as @a[scores={SkyblockCE_large=250}] run scoreboard objectives add structure_skyblock dummy
...
execute as @a[scores={SkyblockCE_large=1355}] run scoreboard players set @a tp 0
...
execute as @a[scores={SkyblockCE_large=1360}] run scoreboard objectives add skyblock_ID dummy
