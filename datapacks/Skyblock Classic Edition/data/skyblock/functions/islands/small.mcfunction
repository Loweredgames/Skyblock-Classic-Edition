...
execute as @a[scores={skyblock_island=3}] run scoreboard objectives add SkyblockCE_small minecraft.custom:minecraft.play_time
execute as @a[scores={skyblock_island=3}] run tellraw @a {"translate":"skyblock_classic_edition.small.loading.chat"}
execute as @a[scores={SkyblockCE_small=1..}] run scoreboard players set @a SkyblockCE_install -1
execute as @a[scores={SkyblockCE_small=1..}] run scoreboard players set @a skyblock_island -1
...
execute in minecraft:overworld as @a[scores={SkyblockCE_small=1}] run title @a title {"translate":"skyblock_classic_edition.small.loading.title"}
execute in minecraft:overworld as @a[scores={SkyblockCE_small=1}] run title @a subtitle {"translate":"skyblock_classic_edition.small.loading.subtitle"}
...
#Small Classic
execute in minecraft:overworld as @a[scores={SkyblockCE_small=1}] run scoreboard players set @a tp 1
...
execute in minecraft:overworld as @a[scores={SkyblockCE_small=10}] run setblock 1 66 0 birch_wall_sign[facing=south,waterlogged=false]{back_text:{messages:['{"text":"This"}','{"text":"is"}','{"text":"a"}','{"text":"secret!!!"}']},front_text:{color:"white",has_glowing_text:1b,messages:['{"text":"Skyblock"}','{"text":"Classic Edition"}','{"text":"---------------"}','{"text":"1.20"}']}} replace
...
execute in minecraft:overworld as @a[scores={SkyblockCE_small=40}] run scoreboard players set @a tp 2
...
execute in minecraft:overworld as @a[scores={SkyblockCE_small=57}] run scoreboard players set @a tp 3
...
execute as @a[scores={SkyblockCE_small=120}] run scoreboard players set @a tp 4
...
execute as @a[scores={SkyblockCE_small=130}] run scoreboard players set @a tp 5
...
##Final Function
execute as @a[scores={SkyblockCE_small=150}] run scoreboard players set @a tp 1
execute as @a[scores={SkyblockCE_small=250}] run scoreboard objectives add structure_skyblock dummy
...
execute as @a[scores={SkyblockCE_small=1355}] run scoreboard players set @a tp 0
...
execute as @a[scores={SkyblockCE_small=1360}] run scoreboard objectives add skyblock_ID dummy
