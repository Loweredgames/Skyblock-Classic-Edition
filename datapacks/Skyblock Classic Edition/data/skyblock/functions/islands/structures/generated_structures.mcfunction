...
execute as @a[scores={PSN_OLD=2}] run effect give @a blindness 62 0 true
execute as @a[scores={PSN_OLD=3}] run effect give @a night_vision 61 0 true
execute as @a[scores={PSN_OLD=1..2000}] run summon minecraft:area_effect_cloud ~ ~1 ~
execute as @a[scores={PSN_OLD=2000000..}] run scoreboard players set @a PSN_OLD 10000
