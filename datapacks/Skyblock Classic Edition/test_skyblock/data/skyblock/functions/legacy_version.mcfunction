...
##Legacy Setup (Aggiornato all'ultima versione: 5.1.2 Minecraft: 1.20.4) Ricordasi di aggiornare "legacy_version", aggiungendo le cose della convesione (il libro,il portale bloccato, ecc.) per le versioni vecchie e incompatibili.
