...
##Legacy Setup (Aggiornato all'ultima versione: 5.0.0 Minecraft: 1.20.2) Ricordasi di aggiornare "legacy_version", aggiungendo le cose della convesione (il libro,il portale bloccato, ecc.) per le versioni vecchie e incompatibili.
