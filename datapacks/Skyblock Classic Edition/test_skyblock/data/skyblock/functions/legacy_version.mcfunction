...
##Legacy Setup (Aggiornato all'ultima versione: 5.1.0 Minecraft: 1.20.3) Ricordasi di aggiornare "legacy_version", aggiungendo le cose della convesione (il libro,il portale bloccato, ecc.) per le versioni vecchie e incompatibili.
