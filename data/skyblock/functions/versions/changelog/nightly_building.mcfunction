...
bossbar set nightly_building name {"text":"JE-1.20.6-5.3.0-Skyblock_Classic_Edition:NIGHTLY_BUILDING_28.12.2024.11843a_[portable/1.20]","color":"white","bold":true}
