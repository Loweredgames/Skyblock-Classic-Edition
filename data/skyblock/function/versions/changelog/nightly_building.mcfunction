...
bossbar set nightly_building name {"text":"JE-1.21/1.21.1-6.0.0-Skyblock_Classic_Edition:NIGHTLY_BUILDING_23.12.2024.11636a_[portable-main]","color":"white","bold":true}
